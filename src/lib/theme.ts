...
/**
 * Skins restyle structure (layout, shapes, typography) while colors come from
 * the active theme. Rules live in `styles/steam-skin.css` under `data-skin`.
 */
...
export const THEMES: ThemeMeta[] = [
  ...
  },
  {
    id: 'steam',
    label: 'Steam',
    description: 'Classic Steam navy blues with light-blue accent.',
...
export const SKINS: SkinMeta[] = [{ id: 'default' }, { id: 'steam' }];
